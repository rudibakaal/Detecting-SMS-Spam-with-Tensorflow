...
ds = pd.read_csv('smsspam.csv',engine='python')
train = ds
...
train['classification'] = label_encoder.fit_transform(train['classification'])
...
history = model.fit(x_train, y_train, epochs=35, validation_split=0.7)
